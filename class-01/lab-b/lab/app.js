...
//    This is the undefined because you can't use a prototype with arrow and this. Improper pattern.
// 2. What is "this" when joe.scopeArrow() is invoked?
//    This is also undefined because it follows improper pattern
// 3. Explain why "this" is different when an arrow function is used.
      //when the arrow function is used, it is used typically for one line of code. When you involve "this", it is referencing the constructor. However, you can't use prototypes and arrow functions so "this" is not relevant.
//
